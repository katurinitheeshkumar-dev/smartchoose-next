          ...
          <div>
            ...
            <ul className="space-y-3 text-slate-400">
              ...
              <li>
                <a
                  href="/about"
                  onClick={(e) => { e.preventDefault(); navigate('/about'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}
                  className="hover:text-white transition-colors cursor-pointer"
                >
                  About
                </a>
              ...
              <li>
                <a
                  href="/blog"
                  onClick={(e) => { e.preventDefault(); navigate('/blog'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}
              ...
              <li>
                <a
                  href="/jobs"
                  onClick={(e) => { e.preventDefault(); navigate('/jobs'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}
                  className="hover:text-white transition-colors text-emerald-400 font-semibold cursor-pointer"
                >
                  Job Alerts
                </a>
              ...
              <li>
                <a
                  href="/sitemap"
                  onClick={(e) => { e.preventDefault(); navigate('/sitemap'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}
                  className="hover:text-white transition-colors cursor-pointer"
                >
                  Sitemap
                </a>
              ...
              <li>
                <a
                  href="/contact"
                  onClick={(e) => { e.preventDefault(); navigate('/contact'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}
                  className="hover:text-white transition-colors cursor-pointer"
                >
                  Contact Us
                </a>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li>
                <a
                  href="/privacy"
                  onClick={(e) => { e.preventDefault(); navigate('/privacy'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}
                  className="hover:text-white transition-colors cursor-pointer"
                >
                  Privacy Policy
                </a>
              ...
              <li>
                <a
                  href="/terms"
                  onClick={(e) => { e.preventDefault(); navigate('/terms'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}
                  className="hover:text-white transition-colors cursor-pointer"
                >
                  Terms of Service
                </a>
              ...
              <li>
                <a
                  href="/disclosure"
                  onClick={(e) => { e.preventDefault(); navigate('/disclosure'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}
                  className="hover:text-white transition-colors cursor-pointer"
                >
              ...
              <li>
                <a
                  href="/returns"
                  onClick={(e) => { e.preventDefault(); navigate('/returns'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}
                  className="hover:text-white transition-colors cursor-pointer"
                >
